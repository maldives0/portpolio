const projectData = [
    {
        key: 'daon',
        title: "웹페이지만 봐도 여행을 떠나고 싶다! Daon Homepage Renewal",
        desc: '팬션 전경을 화면 가득 보여주는 것을 중점적으로 리뉴얼한 반응형 WEB입니다.',
        term: '20.07 - 20.09',
        skills: ['html, css, sass, javascript, jquery'],
        func: 'scrolling, sliding, ajax 등',
        details: 'html, css, javascript를 익히기위한 첫 프로젝트였습니다. 팬션 전경을 Fullpage로 보여주기 위해 scrolling과 sliding 기능에 중점을 두었습니다. UI/UX를 염두해 두고 부드러운 화면 전환을 위해 css animation기능을 활용했습니다. 또한 서비스와 편의시설 화면을 구현할 때 JSON 형식의 데이터를 XHR객체를 이용해 Ajax 프로그래밍했습니다.',
        img: 'img/daon.png'
    },
    {
        key: 'map',
        title: "오늘은 어디 밀롱가를 갈까?! ymillonga map version",
        desc: 'Kakao Map API를 활용해 Vanilla JS으로 만든 장소검색 서비스입니다.',
        term: '20.10 - 20.11',
        skills: ['html, css, sass, javascript'],
        func: 'map searching, dragging 등',
    ...
    },
    {
        ...
        desc: 'React, Next, Redux, Redux Saga, Express를 이용해 Fullstack으로 트위터의 기능을 가진 SNS 서비스입니다',
        term: '20.11 - 20.12',
