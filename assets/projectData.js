const projectData = [
    {
        ...
        details: '이론으로 배운 html5, css3, javascript, git을 익히기위한 첫 프로젝트였습니다. 이 프로젝트를 진행하며 웹브라우저를 프로그래밍적으로 제어하기 위해 순수 javascript을 이용하는 법과 jquery라는 라이브러리를 활용하는 두 가지 방법을 익힐 수 있었습니다. 또한 편의시설을 소개하기위해 popup창을 띄우는 기능을 구현할 때 서버와 클라이언트 간의 데이터를 주고 받는 형식으로서 JSON과 페이지 리로드 없이 웹페이지의 내용을 변경할 수 있는 Ajax API 방식을 익힐 수 있었습니다. 훗날 제가 짠 코드를 보며 class이름이나 변수명이 해당기능을 잘 설명해주지 못하고 있는 점, git에 commit 메세지를 해당 작업에 맞게 적어주지 못한 점이 해당 서비스를 유지보수하는 데 있어서 문제가 된다는 점을 깨닫고 다음 프로젝트부터는 이 부분에 신경을 쓰려고 노력했습니다.',
        img: '/img/daon.jpg',
    ...
    },
    {
        ...
        details: '서비스의 처음부터 배포까지 모두 경험해보고 싶은 욕심에서 시작한 프로젝트였습니다. React Hooks를 사용해 만들었으며 Fullstack으로 전체 서비스가 만들어지는 과정을 경험한 세번째 프로젝트입니다. antd design과 emotion 라이브러리로 화면을 구현하고 Redux, Redux Saga와 연동하여 총 27가지의 sns 기능별 case를 만들보았습니다. 빠른 데이터 fetching이 필요한 부분은 SWR을 사용했습니다. 백앤드에서는 express와 mysql로 서버를 구축했습니다. Next로 SSR를 한 뒤 AWS에 배포하는 과정까지 진행해보았습니다.',
