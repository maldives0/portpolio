      ...
      >
        ...
        <>
          <Modal
            ...
            footer={[
              <Button key="live">
                <Link prefetch="false" href={seletedData.live} target="_blank">
                  <SelectOutlined style={{ marginRight: 2 }} />
                  바로가기
                </Link>
              </Button>,
              <Button key="github" type="primary">
                <Link prefetch="false" href={seletedData.git} target="_blank">
          ...
          >
            ...
            >
              ...
              <Descriptions.Item label="Using Skills">
                {seletedData.skills}
              </Descriptions.Item>
              <Descriptions.Item label="func">
                {seletedData.func}
              </Descriptions.Item>
        ...
        <Row xs={16} sm={12} md={8} className="project-title-layout">
          <Title data-aos="fade-up" data-aos-duration="2000" level={5}>
            이와 같은 프로젝트를 만들며 제가 공부했던 과정이 궁금하시다면 저의
            개인 블로그에 놀러와주세요~
          </Title>
        </Row>
        <Row>
          <Button type="primary" key="blog" className="blog-button-layout">
            <Link
